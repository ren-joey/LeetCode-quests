...
| ------:|---------|----------|------------------|-----------|------------|
|4|Median of Two Sorted Arrays|<span style="color:red">Hard</span>|給予兩組已排序的數字陣列，此兩陣列不可同時為空值。試著找出兩陣列合併後的中位數，且時間複雜度不可超過 O(log(m+n))。|[MODULE](https://gitlab.com/tsuyiren/code-quest/blob/master/src/quests/leetcode/findMedianSortedArrays.js)|[LINK](https://leetcode.com/problems/median-of-two-sorted-arrays/)|
...
|860|Lemonade Change|<span style="color: green">Easy</span>|你經營一間鹽酥雞店，前方有多位客人正在排隊依序購買，每位只能跟你買一份鹽酥雞，每份鹽酥雞售價 5 塊錢，如果顧客支付超過 5 塊錢必須要找錢才算完成交易。你必須完成交易才能服務下一位客人。貨幣共有 5, 10, 20 三種面額，顧客會以任意一種面額進行支付。假設一開始你手上並沒有任何現金，判斷是否有辦法幫所有的顧客完成交易。|[MODULE](https://gitlab.com/tsuyiren/code-quest/blob/master/src/quests/leetcode/lemonadeChange.js)|[LINK](https://leetcode.com/problems/lemonade-change/)|
...
|252|Meeting Rooms|<span style="color: green">Easy</span>| |[MODULE](https://github.com/ren-joey/LeetCode-quests/blob/develop/src/quests/leetcode/meetingRooms.js)|[LINK](https://www.cnblogs.com/grandyang/p/5240774.html)|
|208|Implement Trie|<span style="color: orange">Medium</span>| |[MODULE](https://github.com/ren-joey/LeetCode-quests/blob/develop/src/quests/leetcode/Trie.js)|[LINK](https://leetcode.com/problems/implement-trie-prefix-tree/)|
