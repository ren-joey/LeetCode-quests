...
|41|First Missing Positive|<span style="color:red">Hart</span>|注入一組未排序的整數陣列，找出該陣列缺少的最小正整數。|[MODULE](https://gitlab.com/tsuyiren/code-quest/blob/master/src/quests/leetcode/firstMissingPositive.js)|[LINK](https://leetcode.com/problems/first-missing-positive/)|
