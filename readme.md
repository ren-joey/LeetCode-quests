...
|21|Merge Two Sorted Lists|<span style="color: green">Easy</span>|合併兩組排序過的 linked lists，將結果用一個新的 list 返回，返回的 list 必須經過排序。|[MODULE](https://gitlab.com/tsuyiren/code-quest/blob/master/src/quests/leetcode/mergeTwoLists.js)|[LINK](https://leetcode.com/problems/merge-two-sorted-lists/)|
